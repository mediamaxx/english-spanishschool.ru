        ...
        <div class="container">
            <div class="record__container record__container--main">
                ...
                <div class="record__cell record__cell--right">
                    form form__main
                    [contact-form-7 id="259" title="Пробное занятие"]

                    <div role="form" class="wpcf7" id="wpcf7-f78-o31" lang="ru-RU" dir="ltr">
                        <div class="screen-reader-response"></div>
                        <form action="/#wpcf7-f78-o3" method="post" class="wpcf7-form " novalidate="novalidate">
...
<!--<div class="check-wrapper check-wrapper--services"><label><span class="wpcf7-list-item-label"><span class="input-check__text">Записываясь, вы подтверждаете что ознакомлены с <a href="#">политикой конфиденциальности</a> и согласны на <a href="#">обработку персональных данных</a></span></span></label></div>-->
